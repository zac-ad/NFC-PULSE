      ...
      <div className="max-w-md w-full space-y-6 my-auto py-6">
        ...
        <div className="bg-neutral-950 border border-neutral-800 rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="px-6 pb-6 pt-0 relative">
            <div className="-mt-12 mb-4 flex justify-between items-end">
              <div className="w-24 h-24 rounded-full border-4 border-neutral-950 overflow-hidden bg-neutral-900 shadow-lg">
                {profile.avatar_url ? (
              ...
              <button
                ...
                className="px-4 py-2 bg-white text-black font-semibold text-xs rounded-xl hover:bg-neutral-200 transition-colors shadow-md"
              >
                Save Contact
              </button>
            </div>
          ...
          <div className="space-y-2">
            {socialLinks.map((link) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between p-4 bg-neutral-950 hover:bg-neutral-900 border border-neutral-800 text-white rounded-2xl transition-all group"
              >
        ...
        {qrCodes.length > 0 && (
          <div className="bg-neutral-950 border border-neutral-800 rounded-3xl p-6 space-y-4 shadow-xl">
            <h2 className="text-xs font-bold uppercase tracking-wider text-neutral-400">Payment QRs</h2>
        ...
        {/* Minimal Footer */}
        <footer className="text-center pt-6 border-t border-neutral-900">
          <p className="text-xs font-bold tracking-widest text-neutral-500 uppercase">PULSE</p>
        </footer>
