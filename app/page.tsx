    ...
    <main className="min-h-screen bg-black text-white font-sans selection:bg-neutral-800 flex flex-col relative overflow-hidden">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-12 pb-20 z-10 max-w-5xl mx-auto">
        ...
        <p className="text-neutral-400 text-base sm:text-lg max-w-2xl mb-10 leading-relaxed font-normal">
          PULSE strictly binds one physical NFC pass to one isolated digital profile. No shared links, no cross-contamination. Absolute clarity between work and personal life.
        </p>

        {/* Card Model Selector Preview */}
        <div className="w-full max-w-md bg-neutral-950 border border-neutral-800/80 rounded-3xl p-6 backdrop-blur-xl shadow-2xl relative mb-12 text-left space-y-5">
          <div className="flex items-center justify-between border-b border-neutral-900 pb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono tracking-widest text-neutral-400 uppercase">Dedicated Card Types</span>
            </div>
          ...
          {/* Individual Card Hardware Rendering */}
          <div className="p-5 rounded-2xl bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border border-neutral-800 space-y-4 shadow-inner relative overflow-hidden">
            ...
            <div className="pt-2 flex flex-wrap gap-2 text-[10px] font-mono text-neutral-400">
              <span className="px-2 py-1 rounded bg-neutral-900 border border-neutral-800">
                {selectedCard === 'pro' ? '💼 Executive vCard' : '📸 Instagram Handle'}
              </span>
              <span className="px-2 py-1 rounded bg-neutral-900 border border-neutral-800">
          ...
          <div className="flex items-center justify-between text-[11px] text-neutral-500 font-mono px-1">
            <span>ISOLATION STATUS: LOCKED</span>
            <span>1 CARD = 1 ACCOUNT</span>
          </div>
        </div>
        ...
        <div id="portals" className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-xl">
          ...
          >
            <div className="flex justify-between items-center mb-3">
              <span className="text-xs font-mono font-bold tracking-wider uppercase text-neutral-600">Enterprise Pass</span>
              <span className="text-sm group-hover:translate-x-1 transition-transform">→</span>
            </div>
            <h3 className="text-base font-bold">Professional Portal</h3>
            <p className="text-xs text-neutral-600 mt-1">Access your corporate vCard, work credentials, and tap telemetry.</p>
          </Link>
          ...
          >
            <div className="flex justify-between items-center mb-3">
              <span className="text-xs font-mono font-bold tracking-wider uppercase text-neutral-500">Consumer Pass</span>
              <span className="text-sm group-hover:translate-x-1 transition-transform">→</span>
            </div>
            <h3 className="text-base font-bold">Personal Portal</h3>
            <p className="text-xs text-neutral-400 mt-1">Manage personal social handles, P2P payment handles, and contact notes.</p>
          </Link>
        </div>
      </section>
      ...
      <section id="architecture" className="w-full max-w-5xl mx-auto px-6 py-16 border-t border-neutral-900 z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Strict 1:1 Identity Isolation</h2>
            <p className="text-sm text-neutral-400 leading-relaxed">
              PULSE eliminates confusion by keeping personal and professional presence completely separate. You never have to worry about clients seeing personal social accounts or friends seeing corporate credentials.
            </p>
            <p className="text-sm text-neutral-400 leading-relaxed">
              Each physical card is hard-bound to its respective portal. Logging into the Professional Portal gives you control strictly over your work pass, and vice versa.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-left">
            <div className="p-5 bg-neutral-950 border border-neutral-900 rounded-2xl space-y-2">
              ...
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Dedicated Hardware</h4>
              <p className="text-[11px] text-neutral-500">Each NFC pass holds exactly one identity.</p>
            </div>
            <div className="p-5 bg-neutral-950 border border-neutral-900 rounded-2xl space-y-2">
              <span className="text-xl">🔒</span>
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Zero Cross-Talk</h4>
              <p className="text-[11px] text-neutral-500">No profile switching or data leakage.</p>
            </div>
            <div className="p-5 bg-neutral-950 border border-neutral-900 rounded-2xl space-y-2">
              <span className="text-xl">⚡</span>
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Native Deep-Links</h4>
              <p className="text-[11px] text-neutral-500">Triggers native mobile apps on tap.</p>
            </div>
            <div className="p-5 bg-neutral-950 border border-neutral-900 rounded-2xl space-y-2">
              <span className="text-xl">🛡️</span>
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Privacy Lock</h4>
              <p className="text-[11px] text-neutral-500">Disable any lost pass instantly from your dashboard.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="bg-neutral-950 border border-neutral-800 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-md">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed">
              Water-resistant, industrial-grade matte black passes with built-in high-frequency NFC antennas and printed laser QR fallbacks.
            </p>
